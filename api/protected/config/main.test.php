...
return array(
    ...
    'components'=>array(
        ...
        'db' => array(
            ...
            'connectionString' => 'mysql:host=yougouwx.mysql.rds.aliyuncs.com;dbname=webot4jimubox',
            'emulatePrepare' => true,
            'username' => 'webot4jimubox',
            'password' => 'webot4jimubox',
            'charset' => 'utf8',
        ...
        /*
        'db'=>array(
            'connectionString' => 'mysql:host=rdsvuzn2mvuzn2m.mysql.rds.aliyuncs.com;dbname=webot4jimubox',
            'emulatePrepare' => true,
            'username' => 'webot4jimubox',
            'password' => 'webot4jimubox',
            'charset' => 'utf8',
