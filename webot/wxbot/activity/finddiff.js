            ...
            wechatApi.getUser(info.uid, function(err, user) {
                FinddiffServices.query(user.unionid).then(function(paging) {
                    ...
                    if (finddiffs.length == 0) {
                        ...
                        return next(null, [
                            '亲~速度召集小伙伴们来玩【优购品牌大作战】游戏吧！手快眼力好，优购（←国内最大的时尚鞋服电商）送出的1000张现金礼品卡就有机会被你妥妥赢走！',
                        ...
                        if (finddiff.bonus >= 100) {
                            ...
                            if (over) {
                                ...
                                return next(null, [
                                    ...
                                    '\n想尽快集满100个金币领礼品卡，速度召集小伙伴们来玩【优购品牌大作战】游戏吧！手快眼力好，优购（←国内最大的时尚鞋服电商）送出的1000张现金礼品卡就有机会被你妥妥赢走！',
                                    '\n<a href="' + url + '">点击这里</a>速度参与游戏！'
                                ].join("\n"));
                            }
                        }
