            ...
            wechatApi.getUser(info.uid, function(err, user) {
                FinddiffServices.query(user.unionid).then(function(paging) {
                    ...
                    if (finddiffs.length == 0) {
                        ...
                        return next(null, [
                            '亲~速度召集小伙伴来玩【品牌大作战】游戏吧！手快眼力好，优购（←国内最大的时尚鞋服电商）送出的300元现金礼品卡+大嘴猴/VANS大牌实物豪礼就有机会被你妥妥赢走哦！',
                        ...
                        if (finddiff.rank > 0 && finddiff.rank < 10 && award) {
                            ...
                            if (over) {
                                ...
                                return next(null, [
                                    ...
                                    '\n想提高排名，速度召集小伙伴来玩【品牌大作战】游戏吧！手快眼力好，优购（←国内最大的时尚鞋服电商）送出的300元现金礼品卡+大嘴猴/VANS大牌实物豪礼就有机会被你妥妥赢走哦！',
                                    '\n进入游戏之前，请将手机及微信设置成为横屏模式。',
                                    '\n设置好以后，<a href="' + url + '">点击这里</a>速度参与游戏！'
                                ].join("\n"));
                            }
