...
module.exports = function() {
    describe('test reply api : ', function(){
        ...
        it('failed to create activity data without token', function(done){
            ...
            async.series({
                action: function(callback){
                    base.create("/api/activity", {name: '回复关键字', code: hd1code}, {token: 'basic-none'})
                    .then(function(id) {
        ...
        it('failed to create activity data without reply', function(done){
            // an example using an object instead of an array
            async.series({
                action: function(callback){
                    base.create("/api/activity", {name: '回复关键字', type: 0, code: hd1code}, {token: 'basic-valid'})
                    .then(function(id) {
                        callback(new Error("shuold not create activity without reply"));
                    }, function(err) {
                        done();
                    });
                }
        ...
        it('success to create activity data with basic token', function(done){
            ...
            async.series({
                action: function(callback){
                    base.create("/api/activity", {name: '回复关键字', type: 1, reply: '回复内容', code: hd1code + 'ACT'}, {token: 'basic-valid'})
                    .then(function(id) {
                        activityId = id;
                        done();
                    }, function(err) {
        ...
        it('failed to update activity data without token', function(done){
            ...
            async.series({
                action: function(callback){
                    base.update("/api/activity/" + activityId, {name: '回复关键字', reply: '回复内容updated', code: hd1code + 'ACT'}, {token: 'basic-none'})
                    .then(function(id) {
        ...
        it('success to update activity data within token', function(done){
            ...
            async.series({
                action: function(callback){
                    base.update("/api/activity/" + activityId, {name: '回复关键字', reply: '回复内容updated', code: hd1code}, {token: 'basic-valid'})
                    .then(function(id) {
                        done();
                    }, function(err) {
                        console.info(err);
        ...
        var secActivityId;
        var hd2code = 'HD2' + (new Date()).getTime();
        it('success to create sec activity data with basic token', function(done){
            // an example using an object instead of an array
            async.series({
                action: function(callback){
                    base.create("/api/activity", {name: '活动2', type: 0, reply: '回复内容****', code: hd2code}, {token: 'basic-valid'})
                    .then(function(id) {
                        secActivityId = id;
                        done();
                    }, function(err) {
        ...
        it('failed to update activity data with same code', function(done){
            ...
            async.series({
                action: function(callback){
                    base.update("/api/activity/" + secActivityId, {name: '回复关键字', type: 0, code: hd1code}, {token: 'basic-valid'})
                    .then(function(id) {
                        callback(new Error("should not updated"));
                    }, function(err) {
                        done();
        ...
        it('success to update the sec activity data within token', function(done){
            ...
            async.series({
                action: function(callback){
                    base.update("/api/activity/" + secActivityId, {name: '回复关键字', code: hd2code + 'HD3'}, {token: 'basic-valid'})
                    .then(function(id) {
                        done();
                    }, function(err) {
                        console.info(err);
