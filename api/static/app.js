define(function (require, exports, module) {
    ...
    require('./modules/oper/config.js')(app);
    require('./modules/autoreply/config.js')(app);
    require('./modules/dream/config.js')(app);
    ...
    app.config(['$httpProvider', '$routeProvider', function($httpProvider, $routeProvider) {
        ...
        $routeProvider
            ...
            .otherwise({
                redirectTo: '/autoreply'
            });
        }
    ]);

    //运行期
    app.run(['$lazyload', '$rootScope', 'OperService', function($lazyload, $rootScope, OperService){
        ...
        // 加载用户信息
        OperService.get($.cookie("wexuser")).then(function(user) {
            return user;
        }, function(err) {
            return null;
        }).then(function(user) {
